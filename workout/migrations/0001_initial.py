# Generated by Django 4.0.5 on 2022-07-19 03:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Cardio', 'Cardio'), ('Strength', 'Strength')], default='Strength', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('routine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='routine', to='workout.routine')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('routine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exercises', to='workout.routine')),
            ],
        ),
    ]
